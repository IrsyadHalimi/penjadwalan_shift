...
@endif
  <section id="basic-horizontal-layouts">
    <form method="POST" action="{{ route('superadmin.supervisor.store') }}">
      @csrf
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" name="full_name" class="form-control @error('department_id') is-invalid @enderror" id="full_name-horizontal" value="{{ old('full_name') }}" required autocomplete="full_name" autofocus>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <livewire:superadmin-department-supervisor-dropdown />
                                    @livewireScripts
                                    <div class="row">    
                                        <div class="col-md-4">
