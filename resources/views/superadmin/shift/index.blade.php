                    ...
                    <table class="table table-hover mb-0 mx-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn icon btn-primary" href="{{route('superadmin.shift.edit', ['id'=> $shifts->getId()])}}"><i class="bi-pen"></i></a>
                                </td>    
                                <td>
                                    <form action="{{ route('superadmin.shift.delete', $shifts->getId())}}" method="POST">
                                        @csrf
                                        @method('DELETE')
