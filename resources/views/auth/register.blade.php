            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nomor_pegawai" class="col-md-4 col-form-label text-md-end">{{ __('Nomor Pegawai') }}</label>

                            <div class="col-md-6">
                                <input id="nomor_pegawai" type="text" class="form-control @error('nomor_pegawai') is-invalid @enderror" name="nomor_pegawai" value="{{ old('nomor_pegawai') }}" required autocomplete="nomor_pegawai" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="role" class="col-md-4 col-form-label text-md-end">{{ __('Jabatan (Role)') }}</label>
