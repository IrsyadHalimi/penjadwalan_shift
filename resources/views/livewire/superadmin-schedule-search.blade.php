        ...
        <div class="table-responsive">
            ...
            @foreach ($schedules as $schedule)
                <tr>
                    ...
                    <td>
                        <a class="btn icon btn-primary" href="{{route('superadmin.schedule.edit', ['id'=> $schedule->id])}}"><i class="bi-pen"></i></a>
                    </td>    
                    <td>
                        <form action="{{ route('superadmin.schedule.delete', $schedule->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
