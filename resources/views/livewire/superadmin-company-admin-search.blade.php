        ...
        <div class="table-responsive">
            ...
            @foreach ($company_admins as $company_admin)
                <tr>
                    ...
                    <td>
                        <a class="btn icon btn-primary" href="{{route('superadmin.company_admin.edit', ['id'=> $company_admin->id])}}"><i class="bi-pen"></i></a>
                    </td>    
                    <td>
                        <form action="{{ route('superadmin.company_admin.delete', $company_admin->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
