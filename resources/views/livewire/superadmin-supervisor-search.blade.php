        ...
        <div class="table-responsive">
            ...
            @foreach ($supervisors as $supervisor)
                <tr>
                    ...
                    <td>
                        <a class="btn icon btn-primary" href="#" data-url="{{ route('superadmin.supervisor.edit', ['id' => $supervisor->getId()]) }}" onclick="showConfirmationModal(event, 'edit')">
                            <i class="bi-pen"></i>
                        </a>
                    </td>
                    <td>
                        <form id="deleteForm-{{ $supervisor->getId() }}" action="{{ route('superadmin.supervisor.delete', $supervisor->getId())}}" method="POST" style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
