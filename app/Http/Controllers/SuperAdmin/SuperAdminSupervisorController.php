...
class SuperadminSupervisorController extends Controller
{
  ...
  {
    $viewData = [];
    $viewData["title"] = "Supervisor - Penjadwalan Shift";
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route('superadmin.supervisor.index')->with('success', 'Data berhasil ditambahkan.');
  }
  ...
  public function update(Request $request, $id)
  {
    ...
    return redirect()->route('superadmin.supervisor.index')->with('success', 'Data berhasil diperbarui.');
  }
